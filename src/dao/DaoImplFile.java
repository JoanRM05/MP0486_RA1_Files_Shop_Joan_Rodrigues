	...
	public ArrayList<Product> getInventory() {
		...
		try {
			...
			while (line != null) {
				...
				productos.add(new Product(name, new Amount(wholesalerPrice), true, stock));
	...
	public boolean writeInventory(ArrayList<Product> products) {
		...
		try {
			...
			for (Product product : products) {
				...
				StringBuilder line = new StringBuilder(counterInventory + ";Product:" + product.getName() + ";Stock:" + product.getStock() + ";");
